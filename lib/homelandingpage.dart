...
class HomeLandingPage extends StatelessWidget implements HasLayoutGroup {
  HomeLandingPage({Key key, this.layoutGroup, this.onLayoutToggle})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(
        ...
        layoutType: LayoutType.homepage,
