...
class Favourites extends StatelessWidget implements HasLayoutGroup {
  Favourites({Key key, this.layoutGroup, this.onLayoutToggle})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MainAppBar(
        ...
        layoutType: LayoutType.favourites,
